...
SECRET_KEY = os.environ.get(
    'SECRET_KEY', 'django-insecure-*98pjfolbghmva-vb@!#1%ld++urpwozgob6r!pb+$0qh^j+nn')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = (os.environ.get('DEBUG','True')) != 'False'

ALLOWED_HOSTS = ['*'] #모두 이용이 가능하다는 뜻

AUTH_USER_MODEL = 'account.CustomUser' #인증하는 유저모델로 사용하겠다
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', #whitenoise는 static파일을 관리해주는 프로그램이래
